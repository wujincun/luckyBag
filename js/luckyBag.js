...
var lucyBag = {
    ...
    drawChild: function (ctx) {
        ...
        _this.child.position = [];
        _this.child.position[0] = _this.child.position[0] ? _this.child.position[0]: (_this.w - _this.child.renderSize[0]) / 2;
        _this.child.position[1] =  _this.h - _this.child.renderSize[1];
