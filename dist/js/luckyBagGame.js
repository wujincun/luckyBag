...
var lucyBag = {
    ...
    drawBags: function (ctx) {
        ...
        _this.minBagSpeed = _this.h / 5000;//福袋最小的速度
    ...
    drawLandmine:function (ctx) {
        ...
        _this.minLandMineSpeed = _this.h / 5000;//福袋最小的速度
    ...
    loopScores:function (ctx) {
        ...
        for(var i=0;i<_this.scores.length;i++){
            if(_this.scores[i].position[1] <= _this.h - 360*_this.h/1136){
    ...
    bind: function (ctx) {
        ...
        canvas.addEventListener('touchend', function (e) {
            e.preventDefault();
            _this.flag = false;
            _this.child.initPositionX = _this.positionX || _this.child.position[0];
        });
